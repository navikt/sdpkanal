...
public class SignatureValidator {
	...
	public  SignatureValidator(@Value("${no.nav.sdpkanal.truststore}") String truststorePath, @Value("${no.nav.sdpkanal.checkRevocation}") String certificateRevocationChecking, VaultCredentials vaultCredentials) {
		certValidator = TrustedCertificatesTools.loadTrustedCertificates(new File(truststorePath), vaultCredentials.getTruststorePassword(), certificateRevocationChecking.equals("true"));
