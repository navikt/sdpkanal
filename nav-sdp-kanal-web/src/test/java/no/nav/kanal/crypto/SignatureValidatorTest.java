...
import no.nav.kanal.camel.AddIAIKAsCryptoProvider;
...
public class SignatureValidatorTest {
	...
	public static void oneTimeSetup() {
		AddIAIKAsCryptoProvider iaik = new AddIAIKAsCryptoProvider();
		iaik.toString();
	...
	public void tesSBDSignatureValidator(){
		...
		sv.setTrustStoreFile(new File("src/test/resources/crypto/u-truststore.jks"));
